...
class MainWindow(FluentWindow):
    ...
    def _init_window(self):
        ...
        # 视觉回归 qfluentwidgets 原生 Fluent 主题
        self._apply_app_style()

    def _apply_app_style(self):
        """应用级样式 — qfluentwidgets 原生 Fluent 主题

        早期版本在这里覆盖了大量自定义 QSS（奶油画布/珊瑚红/衬线标题），
        现在只保留水印，视觉交给 qfluentwidgets 的 Fluent Design 实现，
        与系统浅色/深色主题自动一致。
        """
        self._add_watermark()

    def _setup_mica(self):
        """云母/Mica 效果由 qfluentwidgets 主题系统处理"""
        pass
